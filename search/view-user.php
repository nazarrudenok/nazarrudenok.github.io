...
<body>
    <header>
        <div class="header">
            ...
            <?php if (isset($_COOKIE['user']) && $_COOKIE['user'] !== false): ?>
                    <!-- <form action="/search/search.php" method="post" class="search-form">
                        <div class="search-cont">
                            <input type="text" name="search" placeholder="Додай користувача у друзі" autocomplete="off" class="search">
    ...
    <main>
        <div class="main">
            <div class="user-info">
                <div class="user-data">
                        ...
                        <div class="main-data">
                            <?php
                                ...
                                if (in_array($usernameSearch, $allFriendsArray)) {
                                    ...
                                    echo "<div class='hello-settings'><h2><span class='username'>$usernameSite</span></h2></div>";
                                    $note = $searchedUser['note'];
                                    echo "<div class='note-cont'>";
                                    echo "<div class='note-circle'>$noteTime</div><p class='note'>$note</p>";
                                    echo "</div>";
                    ...
                    <div class="second-data">
                        <h1 class="bio-title">Біографія</h1>
                        <div class="bio-cont">
                            <?php
            ...
            <div class="my-posts">
                <?php
                    $searchedUserlogin = $searchedUser['username'];

                    $getMyPosts = $mysql->query("SELECT * FROM `$searchedUserlogin` ORDER BY id DESC");
